...
export default function Hero() {
    ...
    return (
        <section className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center min-h-[80vh] py-12">
            {/* Text Content */}
            <div className="space-y-6">
                <h1 className="text-5xl md:text-6xl font-extrabold tracking-tight">G.M.E. Hansika</h1>
            ...
            {/* Carousel Image */}
            <div className="relative w-full aspect-square max-w-md mx-auto overflow-hidden rounded-3xl border border-zinc-800 shadow-2xl">
