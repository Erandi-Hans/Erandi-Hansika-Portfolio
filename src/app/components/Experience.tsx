...
export default function Experience() {
    ...
    return (
        <section id="experience" className="w-full max-w-[1600px] pt-16 md:pt-20 mx-auto px-6 md:px-12 py-20 border-t border-zinc-800/60 scroll-mt-36">
            <div className="space-y-10">
                ...
                {/* 3 Categories Grid */}
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 pt-6 md:pt-12">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex flex-col p-4 bg-zinc-900/80 border border-zinc-800/80 rounded-2xl gap-4">
                                    <div className="relative w-full h-64 sm:h-80 rounded-xl overflow-hidden bg-zinc-800 border border-zinc-700/80 shadow-md">
                                        <Image
